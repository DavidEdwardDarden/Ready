  ...
  return getToken().then((token) => {
    return fetch(`${_apiUrl}/Quiz/${CategoryId}`, {
      ...
      if (resp.ok) {
        ...
        throw new Error(
          "An unknown error occurred while trying to get questions by firebase User Id and Category Id."
        );
      }
    });
  });
  ...
  return getToken().then((token) => {
    ...
    return fetch(`${_apiUrl}/MyQuestionsList`, {
      ...
      if (resp.ok) {
        ...
        throw new Error(
          "An unknown error occurred while trying to get My Questions."
        );
      }
    });
  });
  ...
  return getToken().then((token) => {
    return fetch(`${_apiUrl}/${Id}`, {
      ...
      if (res.ok) {
        ...
        throw new Error(
          "An unknown error occurred while trying to get the comment."
        );
      }
    });
  });
  ...
  return getToken().then((token) => {
    return fetch(_apiUrl, {
      ...
      if (resp.ok) {
        ...
        throw new Error(
          "An unknown error occurred while trying to save a new question."
        );
      }
    });
  });
