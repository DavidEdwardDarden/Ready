...
import questionmark from "../images/qm4.png"
import "../Home.css";
...
const qmShow=()=>{
  return <img src={questionmark}  alt="user img3"/>
}
  ...
  return (
    <>
      <div className="orange">
        ...
        {/* <img src={questionmark} className="centerme7" alt="user img3"/> */}
        <section onClick={handleQuestionClickEvent} className="questioncard">
        {/* <div className="centermeqanda"> {!showAnswer && src=<div>{()=>{qmShow()}}  alt="questionmark"</div>} </div> */}
...
<div className="centermequizcrown2">
        <div > {!showAnswer &&<div>{<img src={questionmark}  alt="user img3"/>}</div>} </div>
        </div>
        <div className="centermequizcrown3">
        <div > {showAnswer &&<div>{<img src={thing2}  alt="user img3"/>}</div>} </div>
        </div>
